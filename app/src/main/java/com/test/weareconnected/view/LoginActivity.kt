        ...
        binding.loginButton.setOnClickListener {
            ...
            when {
                ...
                password.isEmpty() -> {
                    ...
                    // Query Firestore based on selected user type
                            ...
                            if (document.exists()) {
                                ...
                                if (storedPassword == password) {
                                    if (userTypeInDB == selectedUserType) {
                                        // Successful login
                                        Toast.makeText(this, "Login successful as $selectedUserType", Toast.LENGTH_SHORT).show()

                                        // Save user info to SharedPreferences
                                        appSharedPreferences?.saveMobileNumber(userNumber)
                                        appSharedPreferences?.saveUserType(selectedUserType)
                                        if (userName != null) {
                                            appSharedPreferences?.saveUserName(userName)  // Save the user's name
                                        }
                                        ...
                                        Toast.makeText(this, "User type mismatch", Toast.LENGTH_SHORT).show()
                                    }
                                } else {
